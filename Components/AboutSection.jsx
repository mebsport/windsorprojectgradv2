      ...
      <div className='grid grid-cols-3'>
        <div className='grid-column: span 2'>
          <p className='mt-6 text-black font-semibold text-base sm:text-lg lg:text-xl mb-6'>
            ...
            aimed at providing a safe, drug-free, and fun-filled environment for
            the seniors to celebrate their graduation with their friends. The
            event is entirely managed and organized by parent volunteers, who
            put in a year-long effort to raise funds and plan for the event.
          </p>
